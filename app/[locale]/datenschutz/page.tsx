...
export async function generateMetadata({
  ...
  return createMetadata({
    locale,
    path: "/datenschutz",
    // Hukuki sayfalar tüm dillerde Almanca kalır
    title: () => "Datenschutzerklärung",
    description: () => `Datenschutzerklärung und Informationen zum Datenschutz für ${siteConfig.company.name}`,
  });
}

export default async function DatenschutzPage({ params }: LocalePageProps) {
  ...
  return (
    ...
    >
      {/* Neden lang="de"? İçerik her dilde Almanca; <html lang> ise aktif dili taşır. */}
      <section lang="de" className="legal-page py-120" style={{ padding: "120px 0" }}>
