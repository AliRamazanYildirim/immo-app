                      ...
                      <div className="blog-sidebar__single-content">
                        ...
                        <h2>
                          <Link href="/blog-details">
                            Best Architecture Problem Solution <br />
                            and Creativity
                          </Link>
                        </h2>
                    ...
                    <div className="blog-sidebar__single">
                      <div className="blog-sidebar__single-img">
                        <div
                          ...
                          data-swiper-options='{"spaceBetween": 0,
                                            "slidesPerView": 1,
                                            "loop": true,
                                            "pagination": {
                        ...
                        <div className="main-slider__nav">
                          <div
                            ...
                            id="blog-sidebar__swiper-button-next"
                          >
                            <i
                              className="icon-left-arrow1"
                              aria-hidden="true"
                            ></i>
                          </div>
                          <div
                            className="swiper-button-next"
                            id="blog-sidebar__swiper-button-prev"
                          >
                            <i
                      ...
                      <div className="blog-sidebar__single-content">
                        ...
                        <h2>
                          <Link href="/blog-details">
                            Integration of Passive Design <br />
                            Strategies
                          </Link>
                        </h2>
                        <div className="btn-box">
                        ...
                        <li>
                          <div className="inner">
                            ...
                            <div className="content-box">
                              <h4>
                                <Link href="#">
                                  Keep Your Business <br /> Safe Ensure High
                                </Link>
                              </h4>
                              <p>
                                <span className="icon-clock"></span> April 21,
                                2023
                              </p>
                            </div>
                          </div>
                        ...
                        <li>
                          <div className="inner">
                            ...
                            <div className="content-box">
                              <h4>
                                <Link href="#">
                                  This Week’s Top <br /> Stories About It
                                </Link>
                              </h4>
                              <p>
                                <span className="icon-clock"></span> April 21,
