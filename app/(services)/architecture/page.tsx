                  ...
                  <div className="services-details__content">
                    <div className="services-details__content-img1">
                      <img src="/assets/img/service/services-details-img1.webp"
                        alt="Building Architecture and Planning project" decoding="async" loading="lazy" width={740} height={370} />
                    </div>
                    ...
                    <div className="services-details__content-img2">
                      <img src="/assets/img/service/services-details-arch-img2.webp"
                        alt="Architectural design and engineering studio detail" decoding="async" loading="lazy" width={740} height={370} />
                    </div>
